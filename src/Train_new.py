...
# Cấu hình dòng lệnh
# -------------------------------
parser = argparse.ArgumentParser(description='LG-CAFN training on BreastDM (pretrainedmodels)')
...
# -------------------------------
# Model (dùng FusionM với pretrainedmodels)
# -------------------------------
model = FusionM(
